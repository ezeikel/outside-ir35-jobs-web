  ...
  >
    ...
    <div className="mt-8 border-t pt-6">
      ...
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Enter your day rate, number of days worked, annual salary, and annual
          dividends.
        </li>
        <li>
          We&apos;ll calculate your estimated gross income based on your inputs.
        </li>
        <li>
          We&apos;ll then deduct applicable taxes and expenses to estimate your
          net income.
        </li>
      </ol>
    </div>
